...
# Agregar la carpeta raíz al path para que Alembic pueda encontrar los modelos
...
from models import Base
  # Importar Base después de ajustar sys.path
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            connection=connection, target_metadata=target_metadata, compare_type=True  # Habilitar comparación de tipos
        )
